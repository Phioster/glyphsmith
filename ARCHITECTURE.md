...
The shipped library is **96 presets**:

- **90 curated**, filed by mechanism across 11 categories — Classic Dither (5), Error
  Diffusion (6), Ordered Dither (5), Pattern (15), Print (7), Geometry (5), Color (5), Glitch
